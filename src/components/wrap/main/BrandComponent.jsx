...
export default function BrandComponent({adidas, nike, converse, vans, newbalance, setViewProductDetail, d_key}) {
    ...
    return (
        <main id='brand'>
            ...
            <BrandSection2Component 
                ...
                setViewProductDetail={setViewProductDetail} d_key={d_key}
            />
            <BrandSection3Component 
                ...
                vans={vans}  반스ABC={state.반스ABC} 반스GRAND={state.반스GRAND} 
                newbalance={newbalance}  뉴발란스ABC={state.뉴발란스ABC} 뉴발란스GRAND={state.뉴발란스GRAND}
                abcGrand={abcGrand} setViewProductDetail={setViewProductDetail} d_key={d_key}
            />
        </main>
    );
}
