...
export default function ProductComponent({running, walking}) {
        ...
        .then((res)=>{
            if(res.status===200){
                setState({
                    ...
                    캐주얼ABC:res.data.casual_abc,
                    캐주얼GRAND:res.data.casual_grand,
                    구두ABC:res.data.shoe_abc,
                    구두GRAND:res.data.shoe_grand,
                    샌들ABC:res.data.sandal_abc,
                    샌들GRAND:res.data.sandal_grand
                })
            }
        })
        .catch()
    ...
    React.useEffect(()=>{
        ...
        let arrCasualAbc = [...state.캐주얼ABC]
        let arrCasualGrand = [...state.캐주얼GRAND]
        let arrShoeAbc = [...state.구두ABC]
        let arrShoeGrand = [...state.구두GRAND]
        let arrSandleAbc = [...state.샌들ABC]
        let arrSandalGrand = [...state.샌들GRAND]
    ...
    },[state.스포츠ABC, state.스포츠GRAND, state.캐주얼ABC, state.캐주얼GRAND, state.구두ABC, state.구두GRAND, state.샌들ABC, state.샌들GRAND, running, delivery, pickup])
