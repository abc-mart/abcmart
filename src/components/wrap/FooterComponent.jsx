                ...
                <div className="container">
                    <div className="gap">
                        <div className="content">
                            <div className="box1">
                                <div className="Lbox">
                                    <span className="box1L1">통합고객센터</span>
                                    <span className="box1L2">1588-9667</span>
                                    <span className="box1L3">월~금 09:00 ~ 12:00 / 13:00 ~ 18:00</span>
                                    <span className="box1L4">(주말,공휴일 휴무)</span>
                                </div>
                                <div className="Rbox">
                                    <span className="box1R1"><a href="!#">NOTICE</a></span>
                                    <span className="box1R2"><a href="!#">크록스 제품 발송 안내</a></span>
                            ...
                            <div className="box2">
                                ...
                                <div className="box22">
                                    <div className="ultitle">HELP</div>
                                    <ul>
                                        <li>고객센터</li>
                                        <li>매장 찾기</li>
                                        <li>입점/제휴 문의</li>
                                ...
                                <div className="box23">
                                    <div className="ultitle">BRAND</div>
                                    <ul>
                                        <li>HAWKINS</li>
                                        <li>SPERRY</li>
                                        <li>DANNER</li>
